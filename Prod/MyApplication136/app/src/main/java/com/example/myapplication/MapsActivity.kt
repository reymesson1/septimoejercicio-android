...
import com.example.myapplication.Model.Ubication
import com.example.myapplication.Model.UbicationService
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    fun setUbication(longitute : String, latitute: String){
        ...
        newUbication.latitute = "1.00"
        newUbication.longitute = "2.00"
